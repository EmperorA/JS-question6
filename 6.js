...
Details:    Today we will analyze a very common problem: building search algorithms. 
            ...
            An array of jobs is already provided to you at the beginning of this file, it's quite long, so please DO NOT edit it
             in any way.
            ...
            Example: 
                ...
                if our query was job position = "dev" and location = "US", we should only get job 1 and job 3, which adhere to
                 BOTH the criteria. Job 2 does not match the location param and so we exclude it
            !REQUIREMENTS! 
...
function jobSearch(values, position, loc){
  let newLocation = [1];

for (i = 0; i < values.length; i++) {
    if(values[i].title.search(position) != -1  && values[i].location.search(loc) != -1  )
    newLocation.push(values[i])
        
    }
    console.log(newLocation)
}

jobSearch(jobs, /developer/i, /us/i);
